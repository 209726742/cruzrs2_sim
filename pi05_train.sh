...
OUTPUT_DIR=${OUTPUT_DIR:-$SIM_ROOT/out/training/pi05_fullft_formal300_h100x4_b16_30k_20260818}
JOB_NAME=${JOB_NAME:-}
LOG_FILE=${LOG_FILE:-}

# 多卡和 DataLoader 配置。默认面向 4×H100 80GB 全参数训练；BATCH_SIZE 是每卡 batch，
...
# 全参数训练：同时更新 VLM/PaliGemma 主干、action expert 和投影层。
