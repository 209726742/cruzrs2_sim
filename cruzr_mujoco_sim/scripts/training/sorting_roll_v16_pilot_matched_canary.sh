...
TREATMENT_DATASET=${SORTING_ROLL_V16_TREATMENT_DATASET:-$SIM_ROOT/out/datasets/sorting_roll_v16_pilot_mixed256_20260828_lerobot_v30}
TREATMENT_WEIGHTS=${SORTING_ROLL_V16_TREATMENT_WEIGHTS:-$TREATMENT_DATASET/meta/sampling_weights_old50_h15_t15_r20.npy}
TREATMENT_REPO_ID=${SORTING_ROLL_V16_TREATMENT_REPO_ID:-local/sorting_roll_v16_pilot_mixed256}
RUN_VARIANT=${SORTING_ROLL_V16_RUN_VARIANT:-pilot}
CANARY_GROUPS=${SORTING_ROLL_V16_CANARY_GROUPS:-"control treatment"}
...
configure() {
  ...
  OUTPUT=$SIM_ROOT/out/training/pi05_sorting_roll_v16_${RUN_VARIANT}_${group}_2x4090_${suffix}
  LOG=$PROJECT_ROOT/log/pi05_sorting_roll_v16_${RUN_VARIANT}_${group}_2x4090_${suffix}.log
  JOB=sorting_roll_v16_${RUN_VARIANT}_${group}_2x4090_${suffix}
  SESSION=sorting_roll_v16_${RUN_VARIANT}_${group}_${suffix}
  ARGS=(
